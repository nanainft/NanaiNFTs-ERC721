...
contract NanaiNFT is ERC721, Ownable {
    ...
    constructor() ERC721("NanaiNFTs", "NANA") {
        _contractOwner = msg.sender;
        feeAddress = msg.sender;
    }

    function setFee(address _feeAddress, uint _feePercent) public returns (bool){
        require(_contractOwner == msg.sender, "The Fee can be setted by owner");
    ...
    function burn(uint _id) public returns (bool) {
        _validateBurn(_id);
    ...
    function _validateBurn(uint _id) internal {
        require(_exists(_id), "Error, wrong tokenId");
        require(msg.sender == ownerOf(_id), "Only Owner Can Burn");
    }
    ...
    function _trade(uint _id) internal {
        ...
        feeAddress.transfer(_commissionValue);
